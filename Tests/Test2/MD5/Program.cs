...
Console.WriteLine($"Single-thread hash: {checksumSingleThread}, Time: {stopwatchSingleThread.ElapsedMilliseconds} ms");
...
Console.WriteLine($"Multi-thread hash:  {checksumMultiThread}, Time: {stopwatchMultiThread.ElapsedMilliseconds} ms");